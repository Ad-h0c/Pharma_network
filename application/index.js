...
app.get("/", (req, res) =>
  res.send(
    "Hello Blockchain World, Here comes our hyperledger fabric based PharmaNet App"
  )
);
...
app.get("/initializeAllIdentititiesAtOnce", (req, res) => {
  addToWallet
    .initializeAllIdentititiesAtOnce()
    .then(() => {
      const result = {
        status: "success",
...
app.post("/addToWallet", (req, res) => {
  addToWallet
    .addIdentity(req.body.orgType, req.body.privateKeyFileName)
    .then(() => {
...
app.post("/registerCompany", (req, res) => {
  contractFunctions
    .registerCompany(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/addDrug", (req, res) => {
  contractFunctions
    .addDrug(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/createPO", (req, res) => {
  contractFunctions
    .createPO(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/createShipment", (req, res) => {
  contractFunctions
    .createShipment(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/updateShipment", (req, res) => {
  contractFunctions
    .updateShipment(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/retailDrug", (req, res) => {
  contractFunctions
    .retailDrug(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/viewHistory", (req, res) => {
  contractFunctions
    .viewHistory(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.post("/viewDrugCurrentState", (req, res) => {
  contractFunctions
    .viewDrugCurrentState(req.body.orgType, req.body)
    .then((response) => {
      const result = {
        status: "success",
...
app.listen(port, () =>
  console.log(`Distributed PharmeNet App listening on port ${port}!`)
);
