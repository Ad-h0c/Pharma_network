...
class RetailerContract extends Contract {
  ...
  async createShipment(ctx, buyerCRN, drugName, listOfAssets, transporterCRN) {
    console.log(
      "RetailerContract >> createShipment >> buyerCRN, drugName, listOfAssets, transporterCRN ",
      buyerCRN,
      drugName,
      listOfAssets,
      transporterCRN
  ...
  async retailDrug(ctx, drugName, serialNo, retailerCRN, customerAadhar) {
    console.log(
      "RetailerContract >> retailDrug >> drugName, serialNo, retailerCRN, customerAadhar ",
      drugName,
      serialNo,
      retailerCRN,
      customerAadhar
    ...
    //re-use the common function
    return await commonFunctions.retailDrug(
      ctx,
      drugName,
      serialNo,
      retailerCRN,
